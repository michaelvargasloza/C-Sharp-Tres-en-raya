    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("JUGAR TRES EN RAYA");
                Console.WriteLine("\nJugador 1: X \nJugador 2: O");
                ...
                else //If there is any possition where user want to run and that is already marked then show message and load board again  
                {
                    ...
                    Console.WriteLine("La casilla {0} ya ha sido marcada con {1}", choice, arr[choice]);

                    Console.WriteLine("\n");

                    Console.WriteLine("Por favor espere 2 segundos mientras se carga nuevamente..");
            ...
            if (flag == 1)// if flag value is 1 then some one has win or means who played marked last time which has win  
            {
                ...
                Console.WriteLine("¡GANA EL JUGADOR {0}!", (player % 2) + 1);
        ...
        private static void Board()
        {
            ...
            Console.WriteLine("\nEmpieza el juego, digita entre los números 0-9 para marcar una casilla:\n");
        }
